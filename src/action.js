...
export async function getCurrentData(data) {
    ...
    let currentResult = await Promise.all([
      ...
      axios.post(`https://secas-backend.herokuapp.com/data/current/cshcn`, { data: gidList }),
      axios.post(`https://secas-backend.herokuapp.com/data/current/ecopb`, { data: gidList }),
      axios.post(`https://secas-backend.herokuapp.com/data/current/eqapk`, { data: gidList }),
      ...
      axios.post(`https://secas-backend.herokuapp.com/data/current/grsav`, { data: gidList }),
      ...
      axios.post(`https://secas-backend.herokuapp.com/data/current/lscdn`, { data: gidList }),
      ...
      axios.post(`https://secas-backend.herokuapp.com/data/current/samfs`, { data: gidList }),
      axios.post(`https://secas-backend.herokuapp.com/data/current/scwet`, { data: gidList }),
